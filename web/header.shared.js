(function(){
  ...
  function wireNav(){
    ...
    // keep panel aligned to header on resize
    ...
    // Sync initial mobile role with desktop role selection if available
    try {
  ...
  ready(function(){
    ...
    wireNav();
    // Defensive: force-show toggle if style sheet failed to load
    try {
      ...
      function updateToggleVisibility(){
        ...
        if (window.innerWidth <= 768) {
          ...
          // Remove inline style to let desktop CSS hide it
          t.style.display = '';
        }
      }
